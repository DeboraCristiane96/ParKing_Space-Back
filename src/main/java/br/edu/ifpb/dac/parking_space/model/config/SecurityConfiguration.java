package br.edu.ifpb.dac.parking_space.model.config;
...
import br.edu.ifpb.dac.parking_space.business.service.RoleService.AVALIABLE_ROLES;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  //  Criar os bens da autenticação para gerir o token
    @Bean
    @Override
